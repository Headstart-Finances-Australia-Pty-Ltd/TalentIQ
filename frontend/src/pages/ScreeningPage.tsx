...
import { Briefcase, Phone, Video, ClipboardCheck, CheckCircle } from "lucide-react";
...
import SkillsAssessmentPage from "./SkillsAssessmentPage";
import FinalDecisionPage from "./FinalDecisionPage";

const TAB_BY_PATH: Record<string, "resume" | "phone" | "video" | "skills" | "decision"> = {
  "/app/resumescreening": "resume",
  "/app/phoneinterview": "phone",
  "/app/videointerview": "video",
  "/app/skillsassessment": "skills",
...
// own full page, same as Interview Scheduling/Panel Interviewers/
// Interview Panel/Interview Decision under Interview. Skills Assessment
// also keeps its own standalone sidebar entry/route (unchanged) for
// anyone who wants to jump straight to the question bank or results
// without going through Screening Decision first.
export default function ScreeningPage() {
  const location = useLocation();
  const [tab, setTab] = useState<"resume" | "phone" | "video" | "skills" | "decision">(
